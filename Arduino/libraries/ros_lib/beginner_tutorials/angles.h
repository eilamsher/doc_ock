#ifndef _ROS_beginner_tutorials_angles_h
#define _ROS_beginner_tutorials_angles_h
  ...
  class angles : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->angy_length >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->zhop);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->zhop));
     return offset;
    }

    const char * getType(){ return "beginner_tutorials/angles"; };
    const char * getMD5(){ return "15d49e0238eb7d37253395e6d5b7e7f6"; };
